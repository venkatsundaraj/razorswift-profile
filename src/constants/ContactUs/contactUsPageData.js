...
export const heroSection = {
  ...
  description: "Write to us, and we'll get back to you swiftly!",
  solutions: [
    { id: 1, name: 'Aspirant', slug: 'partners1' },
    { id: 2, name: 'Business', slug: 'partners2' },
    { id: 3, name: 'Partner', slug: 'partners3' },
