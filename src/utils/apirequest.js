...
import { setCustomHeaders } from './encryption.js';
...
const TestURL =
  'https://fwbxwejkzsgejljjo25harpija0picyc.lambda-url.ap-south-1.on.aws/';

const SearchApi =
  'https://asia-south1-razorswift.cloudfunctions.net/searchCandidate';

const ResumeDownload =
  'https://asia-south1-razorswift.cloudfunctions.net/downloadResume';

const PubSub =
  'https://asia-south1-razorswift.cloudfunctions.net/pubsub_receiver';
...
function callApi(
  ...
  return axios({
    ...
    headers: setCustomHeaders(apiHeaders),
  });
}
