...
function degree() {
  ...
  async function degreeGet() {
    ...
    await k.apiDegreeGetAllByPageGet(opts).then(async response => {
  ...
  async function DegreeDelete(id) {
    Swal.fire({
      title: 'Are you sure?',
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: params => (
        <>
          <Tooltip title="View Degree" arrow placement="right">
            <IconButton color="primary" size="small">
              <Link
                href={{
                  pathname: `${config.masterRoutes.degree}/view`,
          ...
          <Tooltip title="Edit Degree" arrow placement="right">
            <IconButton color="primary" size="small">
              <Link
                href={{
                  pathname: `${config.masterRoutes.degree}/AddEdit`,
                  query: { guId: params.row.uniqueGuid },
                }}
                legacyBehavior
              >
          ...
          <Tooltip title="Delete Degree" arrow placement="right">
            <IconButton
              color="primary"
              onClick={() => {
                DegreeDelete(params.row.id);
              }}
              size="small"
            >
              <DeleteIcon
  ...
  return (
    <MainCard
      title="Degree"
      secondary={
        <Tooltip title="Add Degree" arrow placement="right">
