...
function language() {
  ...
  async function languageGet() {
    ...
    await k.apiLanguageGetAllByPageGet(opts).then(async response => {
  ...
  async function languageDelete(id) {
    Swal.fire({
      title: 'Are you sure?',
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: params => (
        <>
          <Tooltip title="View Language" arrow placement="right">
            <IconButton color="primary" size="small">
              <Link
                href={{
                  pathname: `${config.masterRoutes.language}/view`,
          ...
          <Tooltip title="Edit Language" arrow placement="right">
            <IconButton color="primary" size="small">
              <Link
                href={{
          ...
          <Tooltip title="Delete Language" arrow placement="right">
            <IconButton
              color="primary"
              onClick={() => {
                languageDelete(params.row.id);
              }}
              size="small"
            >
              <DeleteIcon
  ...
  return (
    <MainCard
      title="Language"
      secondary={
        <Tooltip title="Add Language" arrow placement="right">
