...
function state() {
  ...
  async function stateGet() {
    ...
    await k.apiStateGetAllByPageGet(opts).then(async response => {
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: params => (
        <>
          <Tooltip title="View State" arrow placement="right">
            <IconButton color="primary" size="small">
              <Link
                href={{
                  pathname: `${config.masterRoutes.state}/view`,
          ...
          <Tooltip title="Edit State" arrow placement="right">
            <IconButton color="primary" size="small">
              <Link
                href={{
                  pathname: `${config.masterRoutes.state}/AddEdit`,
                  query: { guId: params.row.uniqueGuid },
                }}
                legacyBehavior
              >
          ...
          <Tooltip title="Delete State" arrow placement="right">
            <IconButton
              color="primary"
              onClick={() => {
                stateDelete(params.row.id);
              }}
              size="small"
            >
              <DeleteIcon
  ...
  return (
    <MainCard
      title="State"
      secondary={
        <Tooltip title="Add State" arrow placement="right">
