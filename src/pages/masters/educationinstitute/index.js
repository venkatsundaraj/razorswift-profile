...
function educationinstitute() {
  ...
  async function educationinstituteGet() {
    ...
    await k.apiEducationInstituteGetAllByPageGet(opts).then(async response => {
  ...
  async function educationinstituteDelete(id) {
    Swal.fire({
      title: 'Are you sure?',
      text: 'You want to delete this Educational Institute ?',
      icon: 'warning',
      ...
      if (result.isConfirmed) {
        const k = new EducationInstituteApi();
        k.apiEducationInstituteIdDelete(id)
          .then(async response => {
            if (response.body.message === 'Deleted Successfully.') {
              Swal.fire({
                icon: 'success',
                title: 'Delete',
                text: 'Educational Institute Deleted Successfully !',
              });
              educationinstituteGet();
              ...
              Swal.fire({
                icon: 'error',
                title: 'Oops..',
                text: 'Educational Institute Deletion Failed!',
              });
              educationinstituteGet();
            }
  ...
  const columns = [
    ...
    },
    {
      ...
      renderCell: params => (
        <>
          <Tooltip title="View Educational Institute" arrow placement="right">
            <IconButton color="primary" size="small">
              <Link
                href={{
                  pathname: `${config.masterRoutes.educationinstitute}/view`,
          ...
          <Tooltip title="Edit Educational Institute" arrow placement="right">
            <IconButton color="primary" size="small">
              <Link
                href={{
          ...
          <Tooltip title="Delete Educational Institute" arrow placement="right">
            <IconButton
              color="primary"
              onClick={() => {
                educationinstituteDelete(params.row.id);
              }}
              size="small"
            >
              <DeleteIcon
  ...
  return (
    <MainCard
      ...
      secondary={
        <Tooltip title="Add Educational Institute" arrow placement="right">
