...
const JobDescriptions = () => {
          ...
          <Tooltip title="Edit Jobs" arrow placement="right">
            <IconButton
              disabled={
                ...
                // ||params.row.acceptance === AcceptanceType['AcceptanceByClient']
              }
              color="primary"
              size="small"
            >
  ...
  useEffect(() => {
    ...
    if (selectedStatus) {
      fetchJd(selectedStatus.id, opts);
    }
  }, [selectedStatus, fetchJd, clientId]);
...
export default withAuth(JobDescriptions, 'client');
