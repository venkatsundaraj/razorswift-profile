...
const OuterLayout2Copt = ({ explore }) => {
...
export default OuterLayout2Copt;
          ...
          >
            ...
            >
              <Grid item xs={12} sm={6}>
                ...
                <Stack
                  direction={theme.breakpoints.up('sm') ? 'row' : 'column'} // Use row layout for larger screens, column for mobile
