...
import { GeneratedURLs } from '@/src/data/UrlPaths';
...
const Pathway_Type_List = () => {
  ...
  return (
    <ListLayout
      title="Pathway Type"
      secondaryTitle="Add Pathway Type"
      path={GeneratedURLs.pathway_type.create}
      columns={columns}
      pageState={{ ...pageState }}
...
export default Pathway_Type_List;
