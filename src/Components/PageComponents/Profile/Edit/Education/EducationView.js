...
const EducationView = ({
  ...
  }, [educationEdit, yourFunctionToExecuteAfterStateUpdate]);
  ...
  return (
    <Stack>
      ...
      >
        {educationInfo &&
          displayData.map((education, index) => (
            <TimelineItem key={index}>
              ...
              <TimelineContent>
                <Stack spacing={1}>
                  <Stack direction="row">
                    <Title>{education?.primaryEducationInstitute?.name}</Title>
                    <IconButton
                      color="primary"
                      disableRipple
                      size="small"
                      ...
                      onClick={() => {
                        setEducationEdit('3');
                        setEducationInfoEdit(education);
                        if (educationEdit === '3') {
                          yourFunctionToExecuteAfterStateUpdate();
                        }
                      }}
                  ...
                  <SubTitle color="rgba(29, 29, 29, 0.6)" weight="500">
                    {education?.degree?.name},{education?.fieldOfStudy?.name}
                  </SubTitle>
