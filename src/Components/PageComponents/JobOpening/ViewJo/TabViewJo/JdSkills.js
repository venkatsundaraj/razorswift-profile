...
const SoftSkills = () => {
  ...
  const softSkill = jdData?.jdSoftSkills;
  const {
    displayCount,
    handleReadMoreClick,
    handleReadLessClick,
...
const Traits = () => {
  ...
  if (!traits || traits.length === 0) {
    return <NoItemCard Message={'No Other Soft Skills present'} />;
  }
...
const TechnicalSkills = () => {
  ...
  const technicalSkillList = jdData?.jdSkills;
  const {
    displayCount,
    handleReadMoreClick,
    handleReadLessClick,
              ...
              {skill.jdSkillPlatforms &&
                skill.jdSkillPlatforms.map(platform => (
                  ...
                  >
                    ...
                    />
                    {/* <ExperienceBadge weight={platform?.weight} level={platform?.skillLevel} /> */}
                    {/* <Stack
